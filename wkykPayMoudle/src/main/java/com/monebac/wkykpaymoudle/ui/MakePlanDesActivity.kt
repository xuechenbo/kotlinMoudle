...
import com.monebac.wkykpaymoudle.dialog.CalendarDialogFrg
import com.monebac.wkykpaymoudle.dialog.ChangeTypeDialog
import com.monebac.wkykpaymoudle.dialog.ShowPlanMsgDialog
import com.monebac.wkykpaymoudle.event.ClosePlanEvent
import com.monebac.wkykpaymoudle.vm.MakePlanViewModel
...
class MakePlanDesActivity : BaseVmActivity<MakePlanViewModel>() {
    ...
    override fun initData() {
        tv_bank_name.text = bindCard.short_cn_name
    ...
    override fun observe() {
        ...
        mViewModel.run {
            plamMsg.observe(this@MakePlanDesActivity, Observer {
                ...
                ShowPlanMsgDialog().getInstance(it).apply {
                    this.success {
            ...
            tipString.observe(this@MakePlanDesActivity, Observer {
                toast(it)
            })
        }
    }
